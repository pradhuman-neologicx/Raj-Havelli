...
export default function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      user: "ELEANOR_T",
      text: "An absolutely breathtaking experience. The attention to detail in the decor, the impeccable service, and the serene atmosphere make Raj Havelli the finest hotel we have ever stayed in. Highly recommended!",
